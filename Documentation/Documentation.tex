...
program will then run untill the VM halts if no error is encountered.
\\
To make propper use of this machbine one should be familiar with assembly
programming and one should allso read the VM specification and the assembler
usage guide thouroghly.
...
\begin{figure}[H]
\begin{centering}
\includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{Flowchart_VM_rot.png}
